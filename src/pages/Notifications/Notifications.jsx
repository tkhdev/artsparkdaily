  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        {/* Enhanced Icon */}
        <div className={`flex-shrink-0 flex items-center justify-center w-14 h-14 rounded-2xl ${iconData.bgColor} border border-white/10 shadow-inner`}>
          <FontAwesome
            icon={iconData.icon}
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              <h3 className={`text-lg font-bold mb-2 leading-tight ${
                read ? 'text-gray-300' : 'text-white'
              }`}>
                {title}
              </h3>
              <p className={`text-base leading-relaxed mb-3 ${
                read ? 'text-gray-400' : 'text-pink-200'
              }`}>
                {message}
              </p>
            ...
            <div className="flex-shrink-0">
              {!read ? (
                <button
                  ...
                  className="group/btn flex items-center gap-2 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
                >
                  <FontAwesome 
                    icon={faCheck} 
  ...
  >
    ...
    {count > 0 && (
      <span className={`ml-1 px-2 py-0.5 text-xs rounded-full ${
        active ? "bg-white/20" : "bg-pink-500/20 text-pink-400"
      }`}>
        {count}
      </span>
    )}
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            <FontAwesome
              ...
              className="text-5xl text-red-400 mb-6"
            />
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8 p-6 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
          >
